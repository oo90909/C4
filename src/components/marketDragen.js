...
const MarketDragen = () => {
  ...
  useEffect(() => {
    ...
    const fetchNFTs = async () => {
      const length = await getWhoseLength(true,marketAddress);
      console.log('length', length)
      const array = await getAllNFTs(true);
  ...
  return (
    <div>
      ...
      <div className="dradngen-container" style={{ width: '50%' }}>
